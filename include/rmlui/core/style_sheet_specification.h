...
#include "header.h"
#include "property_specification.h"
#include "types.h"
...
private:
	...
	PropertyDefinition& RegisterProperty(PropertyId id, const String& property_name, const String& default_value, bool inherited,
